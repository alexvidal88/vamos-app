...
ActiveRecord::Schema.define(version: 2021_08_06_022645) do
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.index ["weather_search_id"], name: "index_reviews_on_weather_search_id"
  end
  ...
  add_foreign_key "reviews", "weather_searches"
